				...
				<div>
					<select size="10" class="parent-category">
						<?php foreach( $categories as $category ){ ?>
							...
							<option value="<?php echo $category->id;?>" data-haschild="<?php echo $category->getChildCount() > 0 ? 'true' : 'false';?>"><?php echo $category->title; echo $category->getChildCount() > 0 ? '&nbsp;&nbsp;&nbsp;<b>&rsaquo;</b>' : ''; ?></option>
							<?php } ?>
						<?php } ?>
					</select>
				</div>
