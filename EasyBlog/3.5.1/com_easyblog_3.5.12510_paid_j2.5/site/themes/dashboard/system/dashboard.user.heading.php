...
?>
<a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=dashboard&layout=profile' );?>"><img class="dashboard-avatar float-l mrl" src="<?php echo $system->profile->getAvatar();?>" width="55" height="55" /></a>
