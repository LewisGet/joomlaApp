...
<?php foreach( $groups as $group ){ ?>
    <div class="blog-contributions clearfix mts">
		<input<?php echo $external == $group->id && $blogSource == 'group' ? ' checked="checked"' : '';?> id="group-<?php echo $group->id;?>" type="radio" name="blog_contribute" value="<?php echo $group->id;?>" class="input radio" onclick="eblog.dashboard.changeCollab('jomsocial');"/>
