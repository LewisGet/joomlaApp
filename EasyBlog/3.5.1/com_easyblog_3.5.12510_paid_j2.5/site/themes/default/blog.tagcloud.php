	...
	<div class="tag-sort-order clearfix pbm">
		<ul class="reset-ul float-li float-l">
			<li class="sorting-item title">
				<a href="<?php echo EasyBlogRouter::_( $titleURL );?>"<?php echo $ordering == 'title' || empty( $ordering ) ? ' class="active"' : '';?>><?php echo JText::_( 'COM_EASYBLOG_TAGS_ORDER_BY_TITLE' );?></a>
			</li>
			<li class="sorting-item posts">
				<a href="<?php echo EasyBlogRouter::_( $postURL );?>"<?php echo $ordering == 'postcount' ? ' class="active"' : '';?>><?php echo JText::_( 'COM_EASYBLOG_TAGS_ORDER_BY_POST_COUNT' );?></a>
			</li>
			<li class="ordering-item asc">
				<a href="<?php echo EasyBlogRouter::_( $ascURL );?>"<?php echo $sorting == 'asc' ? ' class="active"' : '';?>><?php echo JText::_( 'COM_EASYBLOG_TAGS_SORT_BY_ASC' );?></a>
			</li>
			<li class="ordering-item des">
				<a href="<?php echo EasyBlogRouter::_( $descURL );?>"<?php echo $sorting == 'desc' ? ' class="active"' : '';?>><?php echo JText::_( 'COM_EASYBLOG_TAGS_SORT_BY_DESC' );?></a>
			</li>
			<li class="tag-search">
