...
<?php } ?>
		...
		<p class="rip mts mbm"><?php echo $desc; ?></p>
		<?php } ?>
			...
			<ul class="blog-navi reset-ul float-li clearfix">
				...
				<li class="toolbar-item toolbar-search <?php echo $views->search;?>">
					<form method="get" action="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=search&layout=parsequery' );?>">
						...
						<?php if( JFactory::getConfig()->getValue( 'sef' ) != 1 ){ ?>
						...
						<div class="clearfix">
							<form action="<?php echo JRoute::_( 'index.php' );?>" method="post">
								...
								<label for="passwd" class="float-l width-full rip">
									...
									<?php } else { ?>
										<input type="password" id="passwd" class="input text" name="passwd" />
									<?php } ?>
								</label>
								<div class="mts float-l width-full">
									...
									<?php } ?>
									<button class="button submit float-r" type="submit"><?php echo JText::_('COM_EASYBLOG_LOGIN') ?></button>
								</div>
				...
				<li class="toolbar-item user-micro float-r">
					<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=dashboard&layout=microblog'); ?><?php echo ($system->config->get( 'layout_dashboardanchor' ) ) ? '#write-entry' : '';?>"><span><?php echo JText::_('COM_EASYBLOG_WRITE');?></span></a>
					<div class="tips">
						<i></i>
