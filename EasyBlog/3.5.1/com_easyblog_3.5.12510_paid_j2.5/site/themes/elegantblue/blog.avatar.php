...
<div class="blog-avatar float-l prel">
	<div class="avatar-wrap-a">
		<div class="author-avatar clearfix">
			...
			<a href="<?php echo $row->author->getProfileLink(); ?>" class="avatar isBlogger float-l pabs">
				<img src="<?php echo $row->author->getAvatar(); ?>" alt="<?php echo $this->escape( $row->author->getName() ); ?>" class="avatar" style="width:30px !important; height:30px !important;" width="30" height="30" />
			</a>
			<?php
				} else {
			?>
			<a href="<?php echo $row->author->getProfileLink(); ?>" class="avatar float-l">
				<img src="<?php echo $row->author->getAvatar(); ?>" alt="<?php echo $this->escape( $row->author->getName() ); ?>" class="avatar isBlogger" style="width:60px !important; height:60px !important;" width="60" height="60" />
			</a>
			<?php } ?>
			</div>
		</div>
		...
		<div class="blog-author">
			<?php echo JText::sprintf( 'COM_EASYBLOG_BY_AUTHOR_NAME_LINK', $row->author->getProfileLink(), $row->author->getName()); ?>
		</div>
