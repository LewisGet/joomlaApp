...
class EasyBlogViewEntry extends EasyBlogView
{
	...
	public function commentSave( $post )
	{
		...
		{
			$state		= $this->processRegistrations( $post , $username , $email );
	...
	function saveCBcomment( $post )
	{
		...
		JLoader::import( 'Comment' , EBLOG_ROOT . DS . 'models' );
	...
	public function editComment( $id )
	{
		...
		if( ( ( !$acl->rules->edit_comment || $my->id != $comment->created_by ) || $my->id == 0 ) && !EasyBlogHelper::isSiteAdmin() )
		{
