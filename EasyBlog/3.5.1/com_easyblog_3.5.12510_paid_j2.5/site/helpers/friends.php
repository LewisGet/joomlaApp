...
class EasyBlogFriendsHelper
{
	...
	public function getHTML($bloggerid="")
	{
		...
		{
			$file_core		= JPATH_ROOT . DS . 'components' . DS . 'com_community' . DS . 'libraries' . DS . 'core.php';
			$file_messaging	= JPATH_ROOT . DS . 'components' . DS . 'com_community' . DS . 'libraries' . DS . 'friends.php';
