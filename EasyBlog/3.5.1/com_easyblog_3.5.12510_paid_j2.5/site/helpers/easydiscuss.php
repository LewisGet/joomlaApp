...
class EasyBlogEasyDiscussHelper
{
	...
	{
		jimport( 'joomla.filesystem.file' );
		$file 		= JPATH_ROOT . DS . 'components' . DS . 'com_easydiscuss' . DS . 'constants.php';
		...
		include_once( $file );
		include_once( DISCUSS_HELPERS . DS . 'helper.php' );
	...
	public function readNotification( $targetId , $notificationType )
	{
		...
		if( !class_exists( 'EasyDiscussModelNotification' ) )
		{
			...
			JLoader::import( 'notification' , JPATH_ROOT . DS . 'components' . DS . 'com_easydiscuss' . DS . 'models' );
		}
		...
		$notifications		= JModel::getInstance( 'Notification' , 'EasyDiscussModel' );
