...
{
	function getMedia( &$row , $params, $size = array() )
	{
		$media  = '';
	...
	function getFeaturedImage( &$row , &$params )
	{
	...
	function getResizedImage( $img , $params )
	{
		...
		$thumb	= JPATH_ROOT . DS . str_ireplace( '/' , DS , $matches[ 1 ] );
