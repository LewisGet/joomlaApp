...
class EasyBlogJomSocialHelper
{
	...
	public function addNotification( $title , $type , $target , $author , $link )
	{
		...
		$file 	= JPATH_ROOT . DS . 'components' . DS . 'com_community' . DS . 'libraries' . DS . 'notificationtypes.php';
		...
		{
			$model->add( $author , $targetId , $title , CNotificationTypesHelper::convertNotifId( $type ) , $requireAction , $params );	
		}
