...
class EasyBlogControllerDashboard extends JController
{
	/**
	 * Constructor
	 *
	...
	function save()
	{
		...
		if ( $post['published'] != POST_ID_DRAFT )
		{
			...
			if($post['published'] == POST_ID_PUBLISHED)
			{
				...
				$publishing 	= JFactory::getDate( !isset($post['publish_up']) ? '' : $post[ 'publish_up' ] , $txOffset);
	...
	public function updateComment()
	{
		...
		$comment->modified	= JFactory::getDate()->toMySQL();
	...
	public function removePicture()
	{
		...
		$path				= JPATH_ROOT.DS.$avatar_config_path . DS . $profile->avatar;
