...
class TablePostReject extends JTable
{
	...
	public function store()
	{
		...
		$data[ 'blogEditLink' ]			= EasyBlogRouter::getRoutedURL( 'index.php?option=com_easyblog&view=dashboard&layout=write&id='. $draft->id, false, true);
		...
		{
			$data[ 'blogEditLink' ]			= JURI::root() . 'index.php?option=com_easyblog&view=dashboard&layout=write&id='. $draft->id;
		}
