...
class TableProfile extends JTable
{
	...
	public function getProfileLink()
	{
		...
		if($source == 'phpbb' && $phpbbDB === null)
		{
			...
			$file		= JPATH_ROOT . DS . $phpbbpath . DS . 'config.php';
		...
		if (!isset($instance[$this->id][$source]))
		{
			$defaultLink	= EasyBlogRouter::_( 'index.php?option=com_easyblog&view=blogger&layout=listings&id=' . $this->id );
			...
			$instance[$this->id][$source]	= $ret ? $ret : $defaultLink;
		}

		return $instance[$this->id][$source];
	}
