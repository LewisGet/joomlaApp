		...
		<tr class="row0">
			...
			<td>
				<div class="has-tip">
					...
					<a href="index.php?option=com_easyblog&view=theme&element=<?php echo strtolower( $this->escape( $theme->name ) ); ?>"><?php echo $this->escape( $theme->name );?></a>
				</div>
				
			</td>
			<td style="text-align:center;">
				<a href="<?php echo JRoute::_( 'index.php?option=com_easyblog&c=themes&task=makedefault&element=' . $theme->name . '&' . JUtility::getToken() . '=1' );?>">
