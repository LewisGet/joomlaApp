...
echo $this->loadTemplate( 'social_general' );
echo $pane->endPanel();
...
echo $this->loadTemplate( 'social_stumbleupon' );
echo $pane->endPanel();
echo $pane->startPanel( JText::_( 'COM_EASYBLOG_SETTINGS_SOCIALSHARE_SUBTAB_PINIT' ) , 'PinIt');
echo $this->loadTemplate( 'social_pinit' );
echo $pane->endPanel();
echo $pane->startPanel( JText::_( 'COM_EASYBLOG_SETTINGS_SOCIALSHARE_SUBTAB_TWEETMEME' ) , 'TweetMeme');
echo $this->loadTemplate( 'social_tweetmeme' );
echo $pane->endPanel();
echo $pane->startPanel( JText::_( 'COM_EASYBLOG_SETTINGS_SOCIALSHARE_SUBTAB_ADDTHIS' ) , 'AddThis');
echo $this->loadTemplate( 'social_addthis' );
echo $pane->endPanel();
echo $pane->startPanel( JText::_( 'COM_EASYBLOG_SETTINGS_SOCIALSHARE_SUBTAB_SHARETHIS' ) , 'ShareThis');
echo $this->loadTemplate( 'social_sharethis' );
echo $pane->endPanel();
echo $pane->endPane();
