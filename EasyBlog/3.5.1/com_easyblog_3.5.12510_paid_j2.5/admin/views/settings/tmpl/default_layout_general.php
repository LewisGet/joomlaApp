	...
	<tr>
		...
		<td valign="top">
			...
			<tr>
				<td width="300" class="key">
				<span class="editlinktip">
					<?php echo JText::_( 'COM_EASYBLOG_SETTINGS_LAYOUT_TRUNCATE_MEDIA_POSITIONS' ); ?>
				</span>
				</td>
				<td valign="top">
					<div class="has-tip">
						<div class="tip"><i></i><?php echo JText::_( 'COM_EASYBLOG_SETTINGS_LAYOUT_TRUNCATE_MEDIA_POSITIONS_DESC' ); ?></div>
						<select name="main_truncate_media_position">
							<option value="top"<?php echo $this->config->get( 'main_truncate_media_position' ) == 'top' ? ' selected="selected"' : '';?>><?php echo JText::_( 'COM_EASYBLOG_TOP_OPTION' ); ?></option>
							<option value="bottom"<?php echo $this->config->get( 'main_truncate_media_position' ) == 'bottom' ? ' selected="selected"' : '';?>><?php echo JText::_( 'COM_EASYBLOG_BOTTOM_OPTION' );?></option>
							<option value="hidden"<?php echo $this->config->get( 'main_truncate_media_position' ) == 'hidden' ? ' selected="selected"' : '';?>><?php echo JText::_( 'COM_EASYBLOG_DO_NOT_SHOW_OPTION' );?></option>
						</select>
					</div>
				</td>
			</tr>
