...
class EasyBlogViewSettings extends EasyBlogAdminView
{
	...
	function display($tpl = null)
	{
		...
		{
			if(!JFactory::getUser()->authorise('core.manage.setting' , 'com_easyblog') )
			{
	...
	function getEmailsTemplate()
	{
		...
		$files	= JFolder::files( EBLOG_THEMES . DS . 'default' );
		$emails	= array();
	...
	public function getPaginationSettings( $key , $selected )
	{
		...
		$listLength[] = JHTML::_('select.option', '1', JText::_( '1' ) );
		$listLength[] = JHTML::_('select.option', '2', JText::_( '2' ) );
		$listLength[] = JHTML::_('select.option', '3', JText::_( '3' ) );
		$listLength[] = JHTML::_('select.option', '4', JText::_( '4' ) );
