	...
	<ol class="list-instruction reset-ul pa-15">
		...
		<li>
			...
			<div class="mini-form">
				...
				<input type="text" name="integrations_facebook_secret_key" id="integrations_facebook_secret_key" value="<?php echo $this->config->get( 'integrations_facebook_secret_key' );?>" class="input" style="width:200px" />
			</div>
		</li>
	</ol>
	<input type="hidden" name="integrations_facebook" value="1" />
	<input type="submit" class="button social facebook" value="<?php echo JText::_( 'COM_EASYBLOG_NEXT_STEP_BUTTON' );?>" />
