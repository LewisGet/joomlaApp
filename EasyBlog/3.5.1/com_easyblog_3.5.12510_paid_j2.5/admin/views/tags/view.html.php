...
class EasyBlogViewTags extends EasyBlogAdminView
{
	function display($tpl = null)
	{
		...
		{
			if(!JFactory::getUser()->authorise('core.manage.tag' , 'com_easyblog') )
			{
	...
	function registerToolbar()
	{
		...
		JToolBarHelper::divider();
		JToolBarHelper::custom( 'setDefault' , 'eblog-feature' , '' , JText::_( 'COM_EASYBLOG_MAKE_DEFAULT' ) );
		JToolBarHelper::custom( 'unsetDefault' , 'eblog-unfeature' , '' , JText::_( 'COM_EASYBLOG_REMOVE_DEFAULT' ) );
		JToolBarHelper::divider();
