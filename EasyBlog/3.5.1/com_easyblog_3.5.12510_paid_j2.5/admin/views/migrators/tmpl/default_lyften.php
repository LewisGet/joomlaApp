		...
		<td width="50%" valign="top">
			...
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_EASYBLOG_MIGRATOR_LYFTENBLOGGIE_MIGRATE_COMMENT' ); ?>::<?php echo JText::_('COM_EASYBLOG_MIGRATOR_LYFTENBLOGGIE_MIGRATE_COMMENT_DESC'); ?>">
						<?php echo JText::_( 'COM_EASYBLOG_MIGRATOR_LYFTENBLOGGIE_MIGRATE_COMMENT' ); ?>:
					</span>
					</td>
					<td valign="top">
						 <?php echo JHTML::_('select.booleanlist', 'lyften_comment', 'class="inputbox" style="float:none !important;"', true ); ?>
					</td>
				</tr>
				</tbody>
			</table>
			...
			<div style="padding-top:20px;">
				<button id="migrator-submit3" class="button" onclick="migrateLyftenBloggie();return false;"><?php echo JText::_('COM_EASYBLOG_MIGRATOR_RUN_NOW'); ?></button>
			</div>
