<?php
/**
 * @version $Id: default_subcategories.php 113 2013-01-30 12:14:25Z michal $
 * @package DJ-Catalog2
			...
			<?php if ($subcategory->item_image) { ?>
	        	<div class="djc_image">
	        		<?php if ($this->params->get('image_link_subcategory')) { ?>
						<a rel="lightbox-djsubcategory" title="<?php echo $subcategory->image_caption; ?>" href="<?php echo DJCatalog2ImageHelper::getImageUrl($subcategory->item_image,'fullscreen'); ?>"><img class="img-polaroid" alt="<?php echo $subcategory->image_caption; ?>" src="<?php echo DJCatalog2ImageHelper::getImageUrl($subcategory->item_image,'medium'); ?>"/></a>
	        		<?php } else { ?>
	        			<a href="<?php echo JRoute::_(DJCatalogHelperRoute::getCategoryRoute($subcategory->catslug));?>"><img class="img-polaroid" alt="<?php echo $subcategory->image_caption; ?>" src="<?php echo DJCatalog2ImageHelper::getImageUrl($subcategory->item_image,'medium'); ?>"/></a>
	        		<?php } ?>
				</div>
			<?php } ?>
			<div class="djc_title">
