...
<div id="djcatalog" class="djc_clearfix djc_producer<?php echo $this->params->get( 'pageclass_sfx' ).' djc_theme_'.$this->params->get('theme','default') ?>">
	...
	<?php if ($this->params->get('show_producers_items_item', 1)) { ?>
		<a <?php if (JRequest::getVar('tmpl') == 'component') echo 'target="_blank"'; ?> class="djc_producer_items_link btn btn-mini button" href="<?php echo JRoute::_(DJCatalogHelperRoute::getCategoryRoute(0).'&cm=0&pid='.$this->item->id); ?>"><span><?php echo JText::_('COM_DJCATALOG2_SHOW_PRODUCERS_ITEMS'); ?></span></a>
        <?php } ?>
