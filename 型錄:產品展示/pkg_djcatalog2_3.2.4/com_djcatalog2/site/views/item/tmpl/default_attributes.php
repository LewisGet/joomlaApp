<?php
/**
 * @version $Id: default_attributes.php 112 2013-01-29 14:44:40Z michal $
 * @package DJ-Catalog2
...
<tr class="djc_attribute djc_<?php echo $attributeName; ?>">
	...
	<?php 
		...
		if ($attribute->type == 'textarea' || $attribute->type == 'text'){
			echo nl2br(preg_replace('#([\w]+://)([^\s()<>]+)#iS', '<a target="_blank" href="$1$2">$2</a>', htmlspecialchars($this->item->$attributeName)));
		}
