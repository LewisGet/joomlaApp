<?php
/**
 * @version $Id: license.php 114 2013-02-01 10:04:49Z michal $
 * @package DJ-Catalog2
...
class Djcatalog2ControllerLicense extends JControllerLegacy {
	...
	function update_list(){
		...
		function make_update3(ext,license,version){
			...
			$('update_link_'+ext+'').set('html','".JText::_('COM_DJCATALOG2_DJLIC_PLEASE_WAIT')." <img src=\"".JURI::base()."components/".JRequest::getString('option')."/images/loading.gif\" />');
			...
			var myRequest = new Request({
				...
				onRequest: function(){
					myElement.set('html', '<div style=\"text-align:center;\"><img style=\"margin-top:10px;\" src=\"".JURI::base()."components/".JRequest::getString('option')."/images/long_loader.gif\" /><br />".JText::_('COM_DJCATALOG2_DJLIC_LOADING')."</div>');
				},
