<?php
/**
 * @version $Id: fielddata_legacy.php 105 2013-01-23 14:05:57Z michal $
 * @package DJ-Catalog2
			...
			if (count($this->fieldoptions)) {
				foreach ($this->fieldoptions as $option) {
					$out .= '<tr>
						 ...
						 <input type="text" size="30" name="fieldtype[option][]" value="'.$option->value.'"/>
						 </td>
						 <td>
						 <input type="text" size="4" name="fieldtype[position][]" value="'.$option->ordering.'"/>
