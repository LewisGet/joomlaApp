...
*mod_eb_categories.zip: It displays the event categories which you created . Install it as a Joomla module.
...
*plug_js_acitivities : It is used to show registration information in Jomsocial activities stream. You only need to install it if you are using Jomsocial in your site. 
